...
public class BrokerService
{
  ...
  public List<StockItem> collectData(String symbol, Period period, Date cutTime)
  {
  ...
  private void fulfillOrder(Account account, Order order, Date clock)
  {
    ...
    if (sp == null)
    {
      logger.info("No historitcal price data found for " + order.getStock().getSymbol() + " on [" + Util.format(clock) + "]");
      return;
    }
